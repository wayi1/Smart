#ifndef _HDF5_PARTITIONER_H_                                                           
#define _HDF5_PARTITIONER_H_

#include <string>

#include "partitioner.h"

class HDF5Partitioner : public Partitioner {
 public:
 ...
 protected:
  ...
  bool checkFormat() const override {
    return "h5" == filename_.substr(filename_.size() - 2, 2);
  }
