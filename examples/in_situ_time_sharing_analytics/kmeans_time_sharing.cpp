...
#define NUM_ELEMS 1024*1024*30  // The total number of elements of the simulated data.
#define NUM_ITERS 10  // The # of iterations.
...
int main(int argc, char* argv[]) {
  ...
  SchedArgs args(num_threads2, STEP, (void*)means, NUM_ITERS);
